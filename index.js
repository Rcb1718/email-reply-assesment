...
// These scopes are used to acees and modify the gmail content
const SCOPES = ['https://www.googleapis.com/auth/gmail.readonly', 
'https://www.googleapis.com/auth/gmail.modify', 
'https://www.googleapis.com/auth/gmail.send'];


// token path stores the authorized content
...
// getting the unread messages as it displays to the user what are the unread messages
...
async function replyToall(gmail, messageId, replyContent) {
    try {
      ...
      console.error('Eamil already have been replied:');
    //   throw error;
    }
  }
